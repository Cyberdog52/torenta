...
public class InboundMessageProcessor {
    ...
    private static class DecodingBufferView {
        ...
        @Override
        public String toString() {
            final StringBuilder sb = new StringBuilder("DecodingBufferView{");
            sb.append("unconsumedOffset=").append(unconsumedOffset);
            sb.append(", undecodedOffset=").append(undecodedOffset);
            sb.append(", undecodedLimit=").append(undecodedLimit);
            sb.append('}');
            return sb.toString();
        }
    }
    ...
    private static class BufferedDataWithOffset {
        ...
        @Override
        public String toString() {
            final StringBuilder sb = new StringBuilder("BufferedDataWithOffset{");
            sb.append("pieceIndex=").append(pieceIndex);
            sb.append(", pieceOffset=").append(pieceOffset);
