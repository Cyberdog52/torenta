...
import static ch.andreskonrad.torenta.CustomCacheConfig.RECOMMENDATION_CACHE_NAME;
...
public class CacheCustomizer implements CacheManagerCustomizer<ConcurrentMapCacheManager> {
    ...
    public void customize(ConcurrentMapCacheManager cacheManager) {
        cacheManager.setCacheNames(asList(TMDB_CACHE_NAME, PIRATE_BAY_CACHE_NAME, RECOMMENDATION_CACHE_NAME));
    }
